...
int ll_add(LinkedList* this, void* pElement)
{
    ...
    if(this != NULL) //valido que la lista no este vacia por mas que ya lo haga addNode
    {
...
void* ll_get(LinkedList* this, int index)
{
    ...
    auxNode = getNode(this, index); //No es necesario validacion porque ya lo hace getNode
    if(auxNode != NULL)
    {
...
int ll_set(LinkedList* this, int index,void* pElement)
{
    ...
    //se puede usar ll_get pero las ll estan pensadas para usarse con las node
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this != NULL && this2 != NULL)
    {
        ...
        for(int i=0; i<tam; i++)  //recorro this2
        {
            ...
            if(!ll_contains(this, auxElement)) //se podria poner el contenido de auxElement en su lugar directamente.
            {
                returnAux = 0;
                break;
            }
...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if(this != NULL && pFunc != NULL && order >= 0 && order <= 1)
    {
        ...
        for(int i=0; i<tam; i++)
        {
            ...
            {
                if(pFunc(ll_get(this, i), ll_get(this, j)) > 0 && order) //order == 1
                {
                    auxElement = ll_get(this, i);
                    ll_set(this, i, ll_get(this, j));
                    ll_set(this, j, auxElement);
                }
                else if(pFunc(ll_get(this, i), ll_get(this, j)) < 0 && !order) //order == 0
                {
                    auxElement = ll_get(this, i);
                    ll_set(this, i, ll_get(this, j));
                    ll_set(this, j, auxElement);
...
/** \brief Filter llama a pFunc y le pasa cada uno de los elementos de la lista.
           Devuelve un nuevo linkedList.
           Si Pfunc devuelve 1 en ese elmento lo carga.
 *
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
